    ...
    <KeyboardAvoidingView style={{backgroundColor: '#09172d'}}>
      <View
        ...
        <View style={{alignItems: 'center', marginTop: 20}}>
          <Text style={{fontSize: 37, color: '#dfd1b8'}}>H.I.M</Text>
        </View>
        ...
        <View style={{marginTop: 18, width: '100%'}}>
          <View style={{alignItems: 'center'}}>
            <Text style={{fontSize: 22, color: '#dfd1b8'}}>
        ...
        <View style={{width: '100%', alignItems: 'center'}}>
          ...
          <Text style={{color: '#dfd1b8', fontSize: 16, textAlign: 'center'}}>
            H.I.M is an application that is available on both iOS and Android
            for people in need after a hurricane. The purpose of H.I.M is to
            increase and manage food donations for the community by utilizing
            leftover food.
          </Text>
        </View>
      </View>
